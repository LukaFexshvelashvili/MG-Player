...
const n = document.querySelector(".mg_error_block"),
  ...
  H = document.querySelectorAll(".mg_settings_column"),
...
function closeSettings() {
  P.classList.add("mg_settings_hidden"),
    setTimeout(() => {
      H.forEach((e) => e.classList.add("mg_settings_column_hide")),
        H[0].classList.remove("mg_settings_column_hide");
    }, 200);
}
...
de.forEach((e) => {
  ...
  I.forEach((e) => {
    e.addEventListener("click", () => {
      H.forEach((e) => e.classList.add("mg_settings_column_hide")),
        H[parseInt(e.getAttribute("data-col-index"))].classList.remove(
